...

{
    ...
    public class RagdollBuilder : MonoBehaviour
    {
        ...
        [ContextMenu("FindTransforms")]
        private void FindTransforms()
        {
            pelvis = transform.FindDeepCousin("Hips");
    
            leftHips = transform.FindDeepCousin("LeftUpLeg");
            leftKnee = transform.FindDeepCousin("LeftLeg");
            //leftFoot = null;
    
            rightHips = transform.FindDeepCousin("RightUpLeg");
            rightKnee = transform.FindDeepCousin("RightLeg");
            //rightFoot = null;
    
            leftArm = transform.FindDeepCousin("LeftArm");
            leftElbow = transform.FindDeepCousin("LeftForeArm");
    
            rightArm = transform.FindDeepCousin("RightArm");
            rightElbow = transform.FindDeepCousin("RightForeArm");
    
            middleSpine = transform.FindDeepCousin("Spine1");
            head = transform.FindDeepCousin("Head");
